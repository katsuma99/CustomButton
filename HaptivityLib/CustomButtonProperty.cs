...
namespace StateButtonLib
{
    ...
    public class StateButtonProperty
    {
        ...
        void InitImage()
        {
            ...
            mButtonImage.Add(global::ImageButtonLib.Properties.Resources.BtNormal);
            mOriNormalImage = (Image)mButtonImage[0].Clone();
            mButtonImage.Add(global::ImageButtonLib.Properties.Resources.BtSelect);
            mOriSelectlImage = (Image)mButtonImage[1].Clone();
            mButtonImage.Add(global::ImageButtonLib.Properties.Resources.BtPushed);
